...
const DOC_ID =
  process.env.SHEET_DOC_ID || "1ACIygl6bZNu2ldau0PXLTTsl9kB4LCK6j3bHU5ywXq8";
const GID = process.env.SHEET_GID || "1213054300";

const looksLikeHtml = (t) => /^\s*<(!doctype|html|meta)/i.test(t);
const hasHeaders = (t) => /khetra/i.test(t) && /status/i.test(t);
